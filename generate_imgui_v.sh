...
python3 dear_bindings.py --backend --include ../imgui/imgui.h --imconfig-path ../include/imconfig.h -o ../include/backends/dcimgui_impl_vulkan ../imgui/backends/imgui_impl_vulkan.h
python3 dear_bindings.py --backend --include ../imgui/imgui.h --imconfig-path ../include/imconfig.h -o ../include/backends/dcimgui_impl_glfw ../imgui/backends/imgui_impl_glfw.h
popd
