...
{
    IM_PLACEMENT_NEW(self)ImColor(col);
}
...
{
    IM_PLACEMENT_NEW(self)ImFontAtlasCustomRect();
}
...
{
    IM_PLACEMENT_NEW(self)ImVec2ih(rhs);
}
...
{
    IM_PLACEMENT_NEW(self)ImRect(min,max);
}
...
{
    IM_PLACEMENT_NEW(self)ImRect(v);
}
